//(function() {
    ...
    /*angular is a global variable defined in angular.min.js*/
    ...
    var t3 = {};
    var destruction = {};
    var allDecks = [o1,o2,o3,t1,t2,t3, destruction]; 
    var crewCards;
    var tasks;
    var blairSaucer;
    var thousandMilesToCoast;
    var player1Hand, player2Hand, thingHand;
    var allHands = [player1Hand, player2Hand, thingHand];
    var encounterDeck;
    ...
    var app = angular.module('DeckSim',[]);

    app.controller('StandardDeckAreaCtrl', function($scope) {
        $scope.standardDecks = allDecks;
        
//        this.setStandardDecks = function( inSTD ) {
//            this.standardDecks = inSTD;
//        };
        
        $scope.$watch( 
            'allDecks',
            function(newVal, oldVal) {
                console.log("allDecks changed!");
                //this.standardDecks = newVal;
                //console.log("this.standardDecks[0]: " + this.standardDecks[0]);
            },
            true
        );
    ...
    function initializeStandardDecks(json) {
        ...
        o1.standardInit();
        console.log("o1's testProperty = " + o1.testProperty);
        ...
        console.log("testing allDecks[0].testProperty: " + allDecks[0].name);
        allDecks.push('dongs');
    }
...
//                         " <i><small>"+cards[i].desc+
//                         "("+cards[i].id+")</small></i><p>";
//            }
//            return string;
//        };
    }
